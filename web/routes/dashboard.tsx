...
const menuItems = [
  ...
  { id: "spaces", label: "スペース", icon: "📦" },
  { id: "account", label: "登録情報の変更", icon: "⚙️" },
  { id: "referral", label: "招待クーポン", icon: "🎫" },
];

export default function Dashboard({ data }: PageProps<DashboardData>) {
  const { user, spaces, accessToken, section } = data;
            ...
            <div>
              ...
              <div class="bg-white border border-gray-200 p-6">
                <p class="text-gray-600 mb-4">
                  メールアドレスやパスワードの変更は、プロフィール編集ページから行えます。
                </p>
                <a
                  href="/profile/edit"
