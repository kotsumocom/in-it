  ...
  useEffect(() => {
    ...
    if (initialDataRef.current) {
      try {
        ...
        // 旧形式�EMarkdownチE��スト�E場合�Eパラグラフとして扱ぁE
        parsedData = {
          blocks: [
    ...
    editorInstanceRef.current = new EditorJS({
      ...
      placeholder: "スペ�Eスの詳細を�E力してください...",
      data: parsedData,
      tools: {
        // h3-h6を使用�E�表示はCSSでh1-h4相当にスタイリング�E�E
        header: {
          class: Header,
          config: {
            levels: [3, 4, 5, 6],
  ...
  if (!isLoaded) {
    return (
      <div class="border border-gray-300 p-4 min-h-[200px] bg-gray-50">
        <div class="text-gray-400">エチE��タを読み込み中...</div>
      </div>
    );
  }
