...
interface SpaceFormProps {
  ...
  isSubscribed?: boolean; // サブスクリプション状慁E
}
...
export default function SpaceForm({
  ...
  const handleSubmit = async (e: Event) => {
    ...
    if (!accessToken) {
      setError("認証が忁E��です。�E度ログインしてください、E);
      return;
    }
    ...
    try {
      ...
      if (mode === "create") {
        ...
        if (!res.ok) {
          ...
          throw new Error(data.error || "スペ�Eスの作�Eに失敗しました");
        }
        ...
        if (!res.ok) {
          const data = await res.json();
          throw new Error(data.error || "スペ�Eスの更新に失敗しました");
        }
  ...
  const handleDelete = async () => {
    if (!confirm("本当にこ�Eスペ�Eスを削除しますか�E�E)) {
      return;
    }
    ...
    <form onSubmit={handleSubmit} class="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="侁E Pythonプログラミング入門"
          required
        />
      </div>
      ...
      {/* タグ - 検索可能なコンボ�EチE��ス + 自由入劁E*/}
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">
          タグ�E�褁E��選択�E自由入力可�E�E
        </label>
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <div class="flex gap-2">
              ...
              >
                {isUploadingThumbnail ? "アチE�Eロード中..." : "画像を選抁E}
              </button>
              {thumbnailUrl && (
                <button
                  type="button"
      ...
      {/* 説明（ブロチE��エチE��タ�E�E*/}
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">説昁E/label>
        <BlockEditor
      ...
      {/* Slug - 自動生成�Eため非表示�E�スペ�Eス作�E時に運営が�E動割り振り！E*/}
      ...
      {mode === "edit" && (
        <div class="mt-12 pt-6 border-t border-red-200">
          ...
          <p class="text-sm text-gray-600 mb-4">
            スペ�Eスを削除すると、すべてのチE�Eタが完�Eに削除されます。この操作�E取り消せません、E
          </p>
          <button
            type="button"
