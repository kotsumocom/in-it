...
<head>
  ...
  <meta name="description" content="in-it をインストールするだけで SaaS を始めるのに必要なものが揃う。Everything is in it." />
  <style>
    :root {
      --primary: #6750a4;
      --surface: #fef7ff;
...
<body>
  <section class="hero">
    ...
    <p class="hero__desc">
      ...
      SaaS に必要なもの全部入り。管理画面、認証、決済、LP、ドキュメント。
    </p>
    <div class="hero__actions">
      <a href="/admin" class="btn btn--primary">管理画面デモ →</a>
  ...
  <section class="features">
    <div class="feature">
      ...
      <h3 class="feature__title">ワンスタック</h3>
      <p class="feature__desc">Hono 1 つでサーバーもクライアントも。技術スタックの統一で認知負荷を最小化。</p>
    </div>
    <div class="feature">
      <div class="feature__icon">♿</div>
      <h3 class="feature__title">アクセシビリティ</h3>
      <p class="feature__desc">WAI-ARIA APG 準拠。Switch, Dialog, Tabs, Menu, Select — 全コンポーネントがキーボード操作対応。</p>
    </div>
    <div class="feature">
      <div class="feature__icon">🤖</div>
      <h3 class="feature__title">AI/LLM ネイティブ</h3>
      <p class="feature__desc">シンプルなメンタルモデル。Deno のパーミッションモデルで安全。AI がコード生成しやすい設計。</p>
    </div>
    <div class="feature">
      <div class="feature__icon">🎨</div>
      <h3 class="feature__title">CSS 変数設計</h3>
      <p class="feature__desc">Sawtooth ベースのデザイントークン。テーマ切替もダークモードも CSS 変数で完結。</p>
    </div>
    <div class="feature">
      <div class="feature__icon">📦</div>
      <h3 class="feature__title">ゼロ外部依存</h3>
      <p class="feature__desc">ARIA 実装、ルーター、コンポーネント — 全て自前。Hono 以外の外部依存なし。</p>
    </div>
    <div class="feature">
      <div class="feature__icon">🌐</div>
      <h3 class="feature__title">デュアルランタイム</h3>
      <p class="feature__desc">Deno でも Bun でも動く。Deno Deploy で 1 コマンドデプロイ。</p>
    </div>
  </section>

  <footer>
    <p>© 2026 kotsumo — in-it.ooo</p>
  </footer>
</body>
</html>`;
  return c.html(html);
