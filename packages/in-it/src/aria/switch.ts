...
/** Reactive state of the switch component. */
export interface SwitchState {
  checked: boolean;
  disabled: boolean;
}

/** ARIA props to spread on the switch root element. */
...
/** API returned by {@link createSwitch} for managing switch state and ARIA props. */
...
/** Configuration options for creating a switch instance. */
